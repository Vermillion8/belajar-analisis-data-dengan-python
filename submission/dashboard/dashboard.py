...
merged_hour = pd.read_csv('./submission/dashboard/merged_hour.csv')
merged_month = pd.read_csv('./submission/dashboard/merged_month.csv')
merged_year = pd.read_csv('./submission/dashboard/merged_year.csv')
